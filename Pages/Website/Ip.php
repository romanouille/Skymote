...
<a href="/tools/ping?ip=<?=$ip?>&port=80&protocol=icmp" title="Ping ICMP" class="btn btn-white">Ping ICMP</a>
<a href="/tools/ping?ip=<?=$ip?>&port=80&protocol=udp" title="Ping UDP" class="btn btn-white">Ping UDP</a>&nbsp;
<br><br>

<!--<a href="/tools/traceroute?ip=<?=$ip?>&port=80&protocol=tcp" title="Ping TCP" class="button success">Traceroute TCP</a>&nbsp;-->
<a href="/tools/traceroute?ip=<?=$ip?>&port=80&protocol=icmp" title="Ping TCP" class="btn btn-white">Traceroute ICMP</a>
<a href="/tools/traceroute?ip=<?=$ip?>&port=80&protocol=udp" title="Ping TCP" class="btn btn-white">Traceroute UDP</a>&nbsp;
<?php
