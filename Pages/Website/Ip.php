...
?>
<a href="/tools/ping?ip=<?=$ip?>&port=80&protocol=icmp" class="button" target="_blank">Ping</a>&nbsp;
<a href="/tools/traceroute?ip=<?=$ip?>&port=80&protocol=icmp" class="button" target="_blank">Traceroute</a>
<?php
