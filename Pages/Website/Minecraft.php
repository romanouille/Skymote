...
?>
	...
	<p>Créez gratuitement un serveur Minecraft vanilla pour une durée de 24h renouvelable.</p><br><br>
	...
	<div class="remark info">
		➡️ <b>Utilisation de l'hôte</b>
		<ul>
			<li>CPU : <?=shell_exec("grep 'cpu ' /proc/stat | awk '{usage=($2+$4)*100/($2+$4+$5)} END {print usage \"%\"}'")?><br>
			<li>RAM : <?=shell_exec("free -t | awk 'NR == 2 {print $3/$2*100}'")?>%
		</ul>
	</div>
</div>
<?php
